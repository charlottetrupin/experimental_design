...
var displayShapes = function() {
  ...
  if(visualVariable == "Color") {
    ...
    var num = (objectCount-1)/3
    for (var i = 0; i < objectCount-1; i++) {
      if(targetSize == 10 && targetColor == "Blue") {
        if(i < num){
          objectsAppearance.push({
            size: 20,
            color: targetColor
      ...
      } else if(targetSize == 20 && targetColor == "Blue") {
        if(i < num){
          objectsAppearance.push({
            size: 10,
            color: targetColor
      ...
      } else if(targetSize == 10 && targetColor == "LightBlue") {
        if(i < num){
          objectsAppearance.push({
            size: 20,
            color: targetColor
  ...
  objectsAppearance.splice(ctx.targetIndex, 0, {color:targetColor,size:targetSize});
